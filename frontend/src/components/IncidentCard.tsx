          ...
          {isExpanded && (
            ...
            >
              ...
              {item.hasDiagnosis && item.diagnosis && (
                <div className="diagnosis-box w-full mt-2 px-3 py-2 rounded-md">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <p className="diagnosis-title text-xs font-medium">AI Diagnosis</p>
                      ...
                      <p className="diagnosis-text text-xs">{item.diagnosis}</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {item.hasSolution && item.solution && (
                <div className="solution-box w-full mt-2 px-3 py-2 rounded-md">
                  <div className="flex items-start gap-2">
                    <svg className="w-4 h-4 text-blue-600 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                    </svg>
                    <div className="flex-1">
                      <p className="solution-title text-xs font-medium mb-1">Suggested Solution</p>
                      <p className="solution-text text-xs">{item.solution}</p>
                    </div>
                  </div>
                </div>
              )}
